...
export default function UsersPage() {
  ...
  const validateForm = () => {
    ...
    if (!/^[^\s@]+@[^\s@]+\.[^\s@]+$/i.test(email.trim())) return "L'adresse email est invalide.";
    if (role !== 'parent' && !/^[^\s@]+@ynov\.com$/i.test(email.trim())) return "L'adresse email doit appartenir au domaine @ynov.com.";
          ...
          <div className="user-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <form className="user-form" onSubmit={handleSubmit}>
              ...
              <div className="form-grid">
                ...
                <div className="field-group full-width"><label className="field-label">{selectedRole === 'parent' ? 'Email *' : 'Email professionnel *'}</label><input className="field-input" type="email" name="email" value={formData.email} onChange={handleFieldChange} placeholder={selectedRole === 'parent' ? 'parent@gmail.com' : 'prenom.nom@ynov.com'} disabled={isSubmitting} /></div>
