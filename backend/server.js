...
app.post("/api/auth/consent", authenticateToken, handleAcceptConsent);
...
// Catalogue de filtrage des dashboards : profils et cours réellement présents
// dans les plannings, réservé aux rôles de pilotage.
app.get("/api/plannings/catalog", authenticateToken, authorizeRoles(ROLES.ADMIN, ROLES.EMPLOYEE, ROLES.TEACHER), async (req, res) => {
  try {
